...
void GameObject::set_name(std::string object_name) { name = object_name; };
void GameObject::set_size(std::pair<int, int> object_size) {
  size = object_size;
};

std::pair<int, int> GameObject::get_position() { return position; };
int GameObject::get_position_x() { return position.first; };
int GameObject::get_position_y() { return position.second; };

std::pair<int, int> GameObject::get_size() { return size; };
int GameObject::get_width() { return size.first; };
int GameObject::get_height() { return size.second; };
std::string GameObject::get_sprite() { return sprite; }

void GameObject::set_sprite(std::string path) { sprite = path; }
...
void GameObject::draw() {
  Game& game = Game::get_instance();
  SDL_Rect ret = {position.first, position.second, size.first, size.second};
