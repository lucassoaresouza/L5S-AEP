...
ToScreenButton::ToScreenButton(std::string object_name,
                               std::pair<int, int> object_position,
                               std::pair<int, int> object_size, bool save) {
...
void ToScreenButton::set_screen_name(std::string name) { screen_name = name; }
