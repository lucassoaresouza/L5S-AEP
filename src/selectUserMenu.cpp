...
SelectUserMenu::SelectUserMenu(std::string name) { set_name(name); }
...
void SelectUserMenu::init_background() {
  label_background = new Engine::Field("background", label_background_position,
...
void SelectUserMenu::init_texts() {
  title = new Engine::Field("title", title_position, std::make_pair(0, 0));
  title->set_bold(true);
  ...
  description =
      new Engine::Field("title", description_position, std::make_pair(0, 0));
...
void SelectUserMenu::init_user_input() {
  user_input = new Engine::TextField("user_input", user_input_position, 1, 25);
...
void SelectUserMenu::init_init_button() {
  init_button = new InitUserButton("init_user_button", init_button_position,
                                   std::make_pair(100, 35));
  init_button->set_sprites("./assets/sprites/buttons/button1.png",
