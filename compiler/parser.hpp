...
/**
 ** \file /home/lucas-souza/UnB/TCC/AmbienteDeEnsinoDeProgramacao/compiler/parser.hpp
...
#ifndef YY_YY_HOME_LUCAS_SOUZA_UNB_TCC_AMBIENTEDEENSINODEPROGRAMACAO_COMPILER_PARSER_HPP_INCLUDED
# define YY_YY_HOME_LUCAS_SOUZA_UNB_TCC_AMBIENTEDEENSINODEPROGRAMACAO_COMPILER_PARSER_HPP_INCLUDED
...
#line 63 "/home/lucas-souza/UnB/TCC/AmbienteDeEnsinoDeProgramacao/compiler/parser.hpp"
...
#line 9 "parser.yy"
namespace  Compiler  {
#line 198 "/home/lucas-souza/UnB/TCC/AmbienteDeEnsinoDeProgramacao/compiler/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // command
      char dummy1[sizeof ( Compiler::Command )];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t,  Compiler::Command && v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const  Compiler::Command & v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      case 11: // command
        value.template destroy<  Compiler::Command  > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOKEN_END || tok == token::TOKEN_LEFTPAR || tok == token::TOKEN_RIGHTPAR || tok == token::TOKEN_SEMICOLON || tok == token::TOKEN_COMMA);
      }
#else
    ...
    , location (std::move (that.location))
  {
    ...
    {
      case 11: // command
        value.move<  Compiler::Command  > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    ...
    {
      case 11: // command
        value.copy<  Compiler::Command  > (YY_MOVE (that.value));
        break;
   ...
   Parser ::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    {
      case 11: // command
        value.move<  Compiler::Command  > (YY_MOVE (s.value));
        break;
...
#line 1381 "/home/lucas-souza/UnB/TCC/AmbienteDeEnsinoDeProgramacao/compiler/parser.hpp"





#endif // !YY_YY_HOME_LUCAS_SOUZA_UNB_TCC_AMBIENTEDEENSINODEPROGRAMACAO_COMPILER_PARSER_HPP_INCLUDED
